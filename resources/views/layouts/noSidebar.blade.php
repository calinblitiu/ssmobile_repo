...
<head>
  ...
  {{--<link rel="stylesheet" type="text/css" href="{{ secure_asset('css/bootstrap-formhelpers.css') }}">--}}
  <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/bootstrap-formhelpers.min.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/fileinput.min.css') }}">
  ...
  <style>
    ...
    .navbar-brand {
      ...
      background: url("{{ secure_asset('images/logo.png') }}");
  ...
  <script src="{{ secure_asset('plugins/pace/pace.min.js') }}"></script>
  <link rel="stylesheet" href="{{ secure_asset('plugins/pace/themes/yellow/pace-theme-minimal.css') }}">
      ...
      <div class="col-md-3 col-sm-3 col-xs-3">
        <div class="“logo-confiner”">
          <a href="{{ secure_url('/') }}" class="navbar-brand full-logo">
            <img id="logo-ball-full" alt="Soccer Streams logo" src="{{ secure_asset('images/new_logo.png') }}">
          </a>
        </div>
      </div>
  ...
  <div class="container" id="mobile-view-content" style="position: relative">
    <div class="col-md-12">
      <div class="alert alert-warning">
        ...
        <span class="mobile-view-alert-show" style="display:none;">Soccer Streams is <label class="assassin" style="margin-bottom:0px;font-weight: normal;">still</label> in a beta phase.<br />If you face any bugs, please report them<a style="color:#337ab7 !important;" href="{{ secure_url('contact-us') }}">&nbsp;HERE</a>.</span>
      </div>
      @yield('content')
    </div>
  </div><!-- /.container -->
