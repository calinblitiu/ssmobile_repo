                    ...
                    <tr>
                        @foreach($row as $key => $value)
                            <td class="{{ $key == 'date' ? 'text-left' : 'text-center' }}">
                                ...
                                @else
                                    <a href="{{ secure_url('log-viewer::logs.filter', [$date, $key]) }}">
                        ...
                        @endforeach
                        <td class="text-right">
                            <a href="{{ secure_url('log-viewer::logs.show', [$date]) }}" class="btn btn-xs btn-info">
                                <i class="fa fa-search"></i>
                            </a>
                            <a href="{{ secure_url('log-viewer::logs.download', [$date]) }}" class="btn btn-xs btn-success">
...
@section('modals')
    ...
    <div id="delete-log-modal" class="modal fade">
        <div class="modal-dialog">
            <form id="delete-log-form" action="{{ secure_url('log-viewer::logs.delete') }}" method="POST">
